...
def convert_obj():
    for cls_i, cls_name in enumerate(sel_classes):
        ...
        for set in ["train", "test"]:
            model_list = [
                fn for fn in os.listdir(os.path.join(class_dir, set)) if ".off" in fn
            ]
