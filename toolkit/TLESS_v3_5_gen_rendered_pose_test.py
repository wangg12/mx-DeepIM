...
for cls_idx, cls_name in enumerate(class_list):
    ...
    for video_name in sel_videos:  # 02
        ...
        sel_set_file = os.path.join(
            real_set_root, "{}_{}_{}.txt".format(cls_name, video_name,
                                                 image_set))
        ...
        for real_idx in tqdm(image_list):
            ...
            pose_path = os.path.join(real_data_root,
                                     "{}-pose.txt".format(real_idx))
        ...
        output_file_name = os.path.join(
            pose_dir, 'TLESS_{}_{}_rendered_pose_{}_{}.txt'.format(
                version, image_set, cls_name, video_name))
