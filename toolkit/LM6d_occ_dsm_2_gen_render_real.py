...
real_root_dir = os.path.join(cur_path, '..', 'data',
...
def main():
    for cls_idx, cls_name in enumerate(tqdm(sel_classes)):
        ...
        for idx, real_index in enumerate(tqdm(real_index_list)):
            ...
            # to be written
            render_real_color_file = os.path.join(render_real_dir,
                                                  prefix + "-color.png")
            render_real_depth_file = os.path.join(render_real_dir,
                                                  prefix + "-depth.png")
            render_real_pose_file = os.path.join(render_real_dir,
                                                 prefix + "-pose.txt")

            real_label_file = os.path.join(real_root_dir, video_name,
                                           prefix + "-label.png")
            render_real_label_file = os.path.join(render_real_dir,
                                                  prefix + "-label.png")

            real_pose_file = os.path.join(real_root_dir, video_name,
                                          prefix + "-poses.npy")
