...
classes = [
    'airplane', 'bed', 'bench', 'bookshelf', 'car', 'chair', 'guitar',
    'laptop', 'mantel', 'piano', 'range_hood', 'sink', 'stairs', 'stool',
    'tent', 'toilet', 'tv_stand', 'door', 'glass_box', 'wardrobe', 'plant',
    'xbox', 'bathtub', 'table', 'monitor', 'sofa', 'night_stand'
]
print(classes)
...
for cls_i, cls_name in enumerate(classes):
    if not cls_name in ['bathtub', 'table', 'monitor', 'sofa', 'night_stand'
                        ]:  # airplane
        continue
    print(cls_name)
