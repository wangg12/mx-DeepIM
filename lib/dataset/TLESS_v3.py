...
class TLESS_v3(IMDB):
    def __init__(
        ...
        if len(mask_syn_name) > 0:
            super(TLESS_v3, self).__init__(
                "TLESS_render_v3_" + mask_syn_name,
                image_set,
                root_path,
                devkit_path,
                result_path,
            ...
            super(TLESS_v3, self).__init__(
                "TLESS_render_v3", image_set, root_path, devkit_path, result_path
            )  # set self.name
        ...
        if image_set.startswith("yu_val_v02"):
            ...
            image_set.startswith("train_v1")
            or image_set.startswith("my_val_v1")
            or image_set.startswith("my_minival_v1")
        ):
    ...
    def _load_object_points(self):
        ...
        for cls_idx, cls_name in enumerate(self.classes):
            point_file = os.path.join(
                self._tless_path, "models", cls_name, "points.xyz"
            )
    ...
    def _load_object_diameter(self):
        ...
        with open(models_info_file, "r") as f:
            ...
            for cls_idx, cls_name in enumerate(self.classes):
                ...
                diameters[cls_name] = diameter / 1000.0  # mm --> m
        return diameters
    ...
    def load_render_annotation(self, pair_index):
        ...
        pair_rec[
            ...
            1
        )  # if self.phase=='train' else class_to_index[pair_rec['gt_class']]+1 # test may be not this
