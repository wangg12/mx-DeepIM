    ...
    def __init__(self,
        ...
        if len(mask_syn_name) > 0:
            super(LM6D_occ_v1, self).__init__(
                'LM6d_occ_render_v1_' + mask_syn_name, image_set, root_path,
                devkit_path, result_path)  # set self.name
        else:
            super(LM6D_occ_v1,
                  self).__init__('LM6D_occ_render_v1', image_set, root_path,
                                 devkit_path, result_path)  # set self.name
        self.root_path = root_path
        self.devkit_path = devkit_path
        self.render_real_data_path = os.path.join(devkit_path, 'data',
                                                  'render_real')
